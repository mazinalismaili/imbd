...
public partial class ImdbContext : imdbContext
{
    //public ImdbContext()
    //{
    //}
...
//        => optionsBuilder.UseMySql("server=127.0.0.1;database=imdb;user=root;password=root", Microsoft.EntityFrameworkCore.ServerVersion.Parse("8.4.0-mysql"));
